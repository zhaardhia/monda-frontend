...
const LoginAdmin = () => {
  ...
  const submitUser = async () => {
    ...
    try {
      ...
      await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/v1/user-admin/login-admin`,
        {
          email,
          password,
        },
      ...
      >
        <div className="bg-[#294456] rounded-2xl sm:px-20 px-10 py-10 my-14 xl:w-[70rem] md:w-[50rem] w-[90%] flex flex-col">
          ...
          <div className="flex sm:justify-around justify-center mx-auto w-[100%] my-5 sm:my-0">
            <img src="/loginadmin_man.png" alt="register user" className="sm:block hidden" />
            <div className="flex flex-col gap-5 w-full sm:w-auto sm:mt-14">
              <div>
                <h1 className="text-xl font-semibold text-white">Selamat Datang Kembali, Admin!</h1>
                <p className="text-[#716E6B]">Silahkan masukan Username dan Kata Sandi</p>
              </div>
              <div className="flex flex-col gap-4 w-full items-center">
                ...
                <div className="flex flex-col gap-2 w-full items-center">
                  ...
                  />
                  <div className="flex gap-3 items-center sm:w-full w-[95%]">
                    <input
                      type="checkbox"
