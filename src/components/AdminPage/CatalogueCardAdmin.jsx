...
const CatalogueCardAdmin = ({ data }) => {
  ...
  return (
    <div className="w-64 shadow-xl rounded-lg flex flex-col items-center">
      {data?.image ? (
        <img src={`${process.env.NEXT_PUBLIC_BASE_WEB}${data?.image}`} alt="" className="md:w-[18rem] w-[5rem] object-cover" />
      ) : (
      ...
      <div className="w-[90%] my-4 flex flex-col gap-2">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex h-[2rem]">
            <Link href={"product/detail"} className="w-20 border-[1px] rounded-lg flex justify-center items-center bg-[#DE5959] text-white">
